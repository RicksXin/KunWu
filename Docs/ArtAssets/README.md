...
Figma 文件、组件、主题 Variable、评审状态和 Cocos 映射统一从
[`Docs/Figma/README.md`](../Figma/README.md) 进入；本目录不重复维护这些设计稿规则。
...
| [08_NPC头像与对话肖像.md](08_NPC头像与对话肖像.md) | 9 张实体 NPC/异灵头像、对话/人物列表截图输入、身份设定板与特效变体提示词 |
