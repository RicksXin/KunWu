...
const gaps = [
  ...
  item("ART-HALL-006", "P2公开Demo", "P0-立即", "建筑", "营地大厅", "传送阵/出征入口", 1, "座", 0, 1, "是", "建议360×190逻辑框；阵纹、台基、激活/禁用两态", "使用传送阵文字灰盒", "默认中部完整可见；禁用时仍说明原因", "原创阵纹", "Docs/02 §6.1；Docs/08 §1.2.5"),
  ...
  item("ART-UI-004", "P2公开Demo", "P1-高", "UI", "修士卡牌", "七品级边框（D/C/B/A/S/SS/SSS）", 7, "个", 0, 0, "部分", "字母、轮廓和颜色同时变化", "使用文字等级+单色描边", "色弱模式下仍可辨认", "原创", "PRD-11 §8；PRD-09 §5"),
  ...
  item("ART-UI-014", "P1核心闭环", "P0-立即", "UI", "建筑与生产", "灵圃生产弹窗视觉套件", 1, "套", 0, 0, "是", "主/招募/储量升级弹窗共用纵向九宫格、资源行底板、复用大厅三种资源图标、加减按钮、升级/杂役招募/招募/取消/关闭共用按钮三态、30秒周期条；不制作专用确认弹窗PNG", "先用Kenney面板、纯色资源行和文字按钮接线", "无需切换场景；资源行显示库存/上限和升级；等待30秒能看到资源变化；灵粮或灵木不足时对应确认按钮禁用", "原创UI；只参考第三方截图的信息层级，不复制双龙边框、升级按钮或其他具体造型", "Docs/08 §1.3；PRD-02 §10"),
  item("ART-UI-015", "P1核心闭环", "P0-立即", "UI", "修士与编队", "名册、详情、四人编队页面视觉套件", 1, "套", 0, 0, "是", "七维、三技能、品级、死亡/伤势、四槽位", "先用列表和色块头像", "无前后排暗示；死亡修士不可编队", "原创UI", "Docs/08 §1.4；PRD-03/04"),
  ...
  item("ART-UI-017", "P1核心闭环", "P0-立即", "UI", "背包/装备/出征", "仓库、装备与出征装载页面视觉套件", 1, "套", 0, 0, "是", "物品格、负重条、灵粮携带、确认出征", "使用基础网格和文字", "玩家能区分灵粮与负重并看到无法出征原因", "原创UI", "Docs/08 §1.5–1.6；PRD-07"),
